...
function init() {
    ...
    d3.json(url).then((data) => {
        ...
        names.forEach((name) => {
            ...
            //Append each name as an option to drop down menu
        ...
        //Initiate the functions to make the demographic panel, bar chart, bubble garph and gauge chart
 ...
 function demo(selectedValue) {
    ...
    d3.json(url).then((data) => {
        ...
        //Filter data
        let filterData = metadata.filter(meta =>meta.id == selectedValue);
